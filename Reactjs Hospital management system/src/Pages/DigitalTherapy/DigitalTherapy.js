...
import "./DigitalTherapy.css";
    ...
    function DigitalTherapy() {
      ...
      useEffect(() => {
        fetch("http://localhost:8080/grails-cors/digitalTherapy/indexApi",{ headers })
      ...
      const createDigitalTherapy = () => {
        ...
        if (code && patientProfileId && productId && sessionCompleted && sessionEndDate && sessionNotes && sessionStartDate && status && therapistName) {
          ...
          fetch('http://localhost:8080/grails-cors/digitalTherapy/createApi/', {
            method: 'POST',
            body: body,
            headers: {
      ...
      const updateUser = (id) => {
        ...
        fetch(`http://localhost:8080/grails-cors/digitalTherapy/updateApi/${id}`, {
          method: "PUT",
      ...
      const deleteUser = (id) => {
        fetch(`http://localhost:8080/grails-cors/digitalTherapy/deleteApi/${id}`, {
          method: "DELETE",
        })
          .then((response) => response.json())
          .then(() => {
          ...
          <table class="bp4-html-table .modifier">
            ...
            <tfoot>
              <tr>
                ...
                <td>
                  <Button intent="success" onClick={createDigitalTherapy}>
                    Create DigitalTherapy
                  </Button>
                </td>
                <td>
