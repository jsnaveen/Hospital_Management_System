...
import "./Comp1.css";
  ...
  function Comp1() {
    ...
    useEffect(() => {
      fetch("http://localhost:8080/grails-cors/trust/indexApi",{ headers })
    ...
    const createTrust = () => {
      ...
      if (name && code && location) {
        ...
        fetch('http://localhost:8080/grails-cors/trust/createApi/', {
          method: 'POST',
          body: body,
          headers: {
    ...
    const updateUser = (id) => {
      ...
      fetch(`http://localhost:8080/grails-cors/trust/updateApi/${id}`, {
        method: "PUT",
    ...
    const deleteUser = (id) => {
      fetch(`http://localhost:8080/grails-cors/trust/deleteApi/${id}`, {
        method: "DELETE",
      })
        .then((response) => response.json())
        .then(() => {
        ...
        <table class="bp4-html-table .modifier">
          ...
          <tfoot>
            <tr>
              ...
              <td>
                <Button intent="success" onClick={createTrust}>Create Trust
                </Button>
              </td>
